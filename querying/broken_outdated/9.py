...
def query(sc):
    ...
    for date_table in tables_to_query:
        ...
        if rdd_list_count == 0:
            ...
            current_monthly_table.saveToCassandra("wikikeyspace", query_name+"temp", row_format=pyspark_cassandra.RowFormat.TUPLE)
            rdd_list_count += 1
        ...
        # Query Structure (Total all pages with the word Trump in it over the date range)
            ...
            .saveToCassandra("wikikeyspace", query_name+"temp")
